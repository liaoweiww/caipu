...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '4ba11cf6-6624-11f1-834f-0a61c9cda6da:1-1618';
...
INSERT INTO `recipes` VALUES ('rec_0d0a17ef8c','红烧排骨','https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=600&fit=crop','🍳',NULL,'wx_bzlqzuagcb','mastered','热菜','3','40分钟','[\"咸鲜\", \"酱香\"]','meat',4,17,NULL,0,0,'','','2026-06-16 14:40:05','2026-06-18 15:00:07'),('rec_129c0cc024','麻婆豆腐','/uploads/f631c7570005474bb355cfba4a9ad2d1.png','🍳',NULL,'wx_bzlqzuagcb','mastered','热菜','3','20分钟','[\"麻辣\"]','meat',3,15,NULL,0,0,'','','2026-06-16 17:00:03','2026-06-18 14:58:11'),('rec_1b0b170448','番茄炒蛋','https://images.unsplash.com/photo-1592417817098-8fd3d9eb14a5?w=600&h=600&fit=crop','🍳',NULL,'wx_bzlqzuagcb','mastered','素菜','1','10分钟','[\"咸鲜\"]','mix',3,11,NULL,0,0,'','','2026-06-16 14:40:06','2026-06-18 14:58:11'),('rec_3817349f4e','紫菜蛋花汤','https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&h=600&fit=crop','🍳',NULL,'wx_bzlqzuagcb','mastered','汤类','1','5分钟','[\"清淡\"]','mix',3,33,NULL,0,0,'','','2026-06-16 18:15:52','2026-06-18 14:58:11'),('rec_5da0bd0274','酸辣土豆丝','/uploads/1fb4cd197d374da5ae636f39090cb965.png','🍳',NULL,'wx_bzlqzuagcb','mastered','素菜','1','10分钟','[\"酸辣\"]','veg',3,52,NULL,0,0,'','','2026-06-16 18:15:52','2026-06-18 14:58:11'),('rec_6e440a1876','糖醋里脊','https://images.unsplash.com/photo-1525755662778-989d0524087e?w=600&h=600&fit=crop','🍳',NULL,'wx_bzlqzuagcb','mastered','热菜','3','25分钟','[\"酸甜\"]','meat',4,22,NULL,0,0,'','','2026-06-16 18:15:52','2026-06-18 14:58:11'),('rec_8281cf20c6','清蒸鲈鱼','https://images.unsplash.com/photo-1534604973900-c43ab4c2e0ab?w=600&h=600&fit=crop','🍳',NULL,'wx_bzlqzuagcb','mastered','热菜','2','20分钟','[\"咸鲜\", \"清淡\"]','meat',4,27,NULL,0,0,'','','2026-06-16 14:40:06','2026-06-18 14:58:11'),('rec_92af4b56cd','1','/uploads/8a899a1704b8486793638d94c1d53e5a.png','🍳',NULL,'wx_bzlqzuagcb','mastered','','3','','[]','mix',4,0,NULL,0,0,'','','2026-06-18 15:39:47','2026-06-18 15:39:47'),('rec_cfe35aa5b9','回锅肉','/uploads/f91cb00455e040768a21ff6d9ca467a9.png','🍳',NULL,'wx_bzlqzuagcb','mastered','热菜','3','30分钟','[\"咸鲜\", \"酱香\"]','meat',4,29,NULL,0,0,'','','2026-06-16 15:54:18','2026-06-18 14:58:11'),('rec_dbdc9b452c','水煮鱼','https://images.unsplash.com/photo-1559847844-5315695dadae?w=600&h=600&fit=crop','🍳',NULL,'wx_bzlqzuagcb','mastered','热菜','4','30分钟','[\"麻辣\", \"咸鲜\"]','meat',4,18,NULL,0,0,'','','2026-06-16 18:15:52','2026-06-18 14:58:11');
...
-- Dump completed on 2026-06-18 17:52:42
